...
import { DatePicker, Checkbox, Pagination, Icon, Tooltip, Dropdown, Menu, Button, Col } from 'antd'
...
export default class ListRow extends Component {
    ...
    componentWillUnmount() {
        const { handleStatePagingPhase } = this.props
        handleStatePagingPhase(1, 10, 10) //default pageNo, pagiSize, totalRows
    }
    ...
    onChangePagging = (value, row) => {
        const { handleChange, handlePagination, pageNoPhase, pageSizePhase, totalRowsPhase } = this.props
        let pagingPhase = {
            pageNo: pageNoPhase,
            pageSize: pageSizePhase,
            totalRows: totalRowsPhase
        }
        handlePagination('current', value, pagingPhase)
        handleChange('current', value, pagingPhase)
    }

    onChangeShowSize = (current, size) => {
        ...
        handlePagination('current', current, pagingPhase)
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center' }}>
                                        ...
                                        >
                                            <Icon
                                                ...
                                                style={{
                                                    fontSize: 20,
                                                    display: rolebyAuth['CancelbyCandidate'] == true ? 'none' : 'block'
                                                }}
                                            />
                                        </Tooltip>
                                        <Tooltip
                                        ...
                                        {date !== null ? (
                                            <IconContext.Provider value={{ color: '#585858', size: 20 }}>
                                                <Tooltip
                                                    ...
                                                    onClick={() => onAction('SendEmailInvitation')}
                                                    style={{
                                                        paddingLeft: 10,
                                                        display: 'flex',
                                                        alignItems: 'center'
                                                ...
                                                >
                                                    {rolebyAuth['SendInvitation'] == true ? null : <FiSend />}
                                                </Tooltip>
                                ...
                                <div className="ListRowBoxContentRight">
                                            ...
                                            <Menu>
                                                ...
                                                {x.FGDTestResult ? (
                                                    <Menu.Item
                                                        style={{
                                                            display:
                                                                rolebyAuth['DatepickerSendInvt'] == true
                                                                    ? 'none'
                                                                    : 'block'
                                                        }}
                                                        key="2"
                                                        onClick={() => {
                                                            resetModal('modalFGD')
                                                            handleStateFGD('ApplicationId', x.ApplicationId)
                                                            handleStateFGD('visible', true)
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* {x.EmailSent && (
                                                <div className="boxInfoRow">
                                                    <Icon type="check" style={{ paddingRight: 5, color: '#43dd5d' }} />{' '}
                                                    Email sent
                                                </div>
                                            )} */}
                                    ...
                                    <div className="ListRowBoxList">
                                        ...
                                        <div className="ListRowBoxImage">
                                            <img
                                                ...
                                                loading="lazy"
                                                onError={e => {
                                                    ;(e.target.onerror = null), (e.target.src = ImgDummy)
                                                }}
                                            />
                                        </div>
                    ...
                    {list.length !== 0 && (
                        ...
                        >
                            ...
                            <div>
                                ...
                                {rolebyAuth['UploadTestResult'] == true ? null : (
                                    <Button onClick={() => handleStateUpload('visible', true)} type="primary">
                ...
                {list.length !== 0 ? (
                    <div className="pagination">
                        <Pagination
                            ...
                            onShowSizeChange={this.onChangeShowSize}
                            defaultCurrent={current}
                            total={total}
                            onChange={this.onChangePagging}
                        />
                    </div>
                ) : null}
            </div>
