...
class ModalEmail extends Component {
    ...
    onCancelModal = () => {
        const { resetCheckAction, handleStateModal, getEmailRedac,
            handleStateModalEmailTemplate } = this.props
        if (this.state.isEdit) {
            ...
            try {
                if (this.props.handleStateGlobal !== undefined) {
                    this.props.handleStateGlobal("clearFlagModalFailedInterview", true)
                }
            } catch (e) {}
    ...
    render() {
        const { visible, subject, body, signature, 
                handleStateModal, modalAction, 
