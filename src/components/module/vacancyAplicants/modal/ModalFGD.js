...
class ModalFGD extends Component {
    ...
    render() {
        const { title, visible, tglTest, hasilTest, uploadFile, notesOnline, handleState, file } = this.props
...
const WrappedForm = Form.create()(ModalFGD);
